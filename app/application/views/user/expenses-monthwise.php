    ...
    <br />
		<div class="row filters">
			<form action="" id="form_search_filter">
				...
				<button type="button" class="btn btn-warning" onclick="clear_search('user')" style="float:right"><i class="glyphicon glyphicon-remove"></i> Clear Filter</button>
				</div>
				</div>
			</form>
		</div>
		...
		<?php
			...
			?>
				<tr>
					...
					<td><a href="<?php echo base_url('user/expense-detail').'/'.strtotime($value->expense_year_month); ?>" class="btn btn-info" target="_blank"><i class="glyphicon glyphicon-new-window"></i> View Detail</a></td>
				</tr>
		<?php }
			}?>
      </tbody>
